...
import com.example.jdbc_with_dao_pattern.configration.HikariCPConfiguration;
...
public class App {
    public static void main(String[] args) throws SQLException {
        ...
        try(Connection connection = HikariCPConfiguration.getInstance().getDataSource().getConnection()){
